function API(client){
  ...
  this.artists  = function(req, res){ client.request('AudioLibrary.GetArtists', {properties:info.artist, albumartistsonly:true}, function(a){ res.json(a.result.artists) }) }
