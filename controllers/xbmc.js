function API(client){
  ...
  this.status     = function(req, res){ client.chain('Player.GetActivePlayers', {}, function(){ client.command('Player.GetItem', {}, res) }) }
  ...
  this.songs    = function(req, res){ client.request('AudioLibrary.GetSongs', {properties:info.song, limits:{end:50}}, function(data){ res.json(data.result.songs) }) }
