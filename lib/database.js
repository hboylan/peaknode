...
Zone.hasMany(Audio).hasMany(Light).hasMany(Appliance).hasMany(Lock).hasMany(models.temperature_archive, {as:'tempReadings'})
...
models.resync = function(req, res){
  ...
  resyncTable(Zone, config.zones.reverse(), function(){
