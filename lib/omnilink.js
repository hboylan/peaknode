...
OmniClient.prototype.connect = function(){
  this.connection.connect(config.tcp_port, config.tcp_host, function() {
    ...
    console.log('OMNI connected localhost:'+config.tcp_port)
  })
}
...
OmniClient.prototype.light = function(method, data){
  this.command('light.'+method, data)
}

OmniClient.prototype.audio = function(method, data){
  this.command('audio.'+method, data)
}

OmniClient.prototype.security = function(method, data){
  this.command('security.'+method, data)
}
